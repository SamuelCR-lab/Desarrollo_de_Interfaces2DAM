...
public class AccionesDeBotonesSA implements ActionListener{
	...
	JPanel ejecutadorAccion;
	
	
	public AccionesDeBotonesSA(int ocultarOMostrar, String nombrePanel,JPanel ejecutadorAccion) {
		super();
		this.ocultarOMostrar = ocultarOMostrar;
		this.NombreAccion = nombrePanel;
		this.ejecutadorAccion = ejecutadorAccion;
	}
	...
	public JPanel getEjecutadorAccion() {
		return ejecutadorAccion;
	}
	public void setEjecutadorAccion(JPanel ejecutadorAccion) {
		this.ejecutadorAccion = ejecutadorAccion;
	}
